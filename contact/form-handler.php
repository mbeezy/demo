...
$use_smtp = '0';
$emailto = 'bolanos.mike@gmail.com';

	// retrieve from parameters
	$emailfrom = isset($_POST["email"]) ? $_POST["email"] : "";
	$nocomment = isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$demoBoardInterest = isset($_POST["demo_board"]) ? $_POST["demo_board"] : "";
	$subject = 'Email from DemoSurfboards';
	$message = '';
	$response = '';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Thanks! Someone will get back to you shortly!';
	...
	if($use_smtp == '1'){
		...
		$SmtpServer = 'ssl://premium4.web-hosting.com';
		$SmtpPort = '';
		$SmtpUser = '';
		$SmtpPass = '';
		...
		// Create header
		$headers = "From: no-reply@demosurfboards.com\r\n";;
